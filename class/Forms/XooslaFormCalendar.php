...
class XooslaFormCalendar extends \XoopsFormElement
{
    ...
    public function __construct(
        ...
        $lang                      = file_exists(XOOPS_ROOT_PATH . 'modules/xooslacore/thirdparty/calendar/lang/calendar-' . _LANGCODE . '.js') ? _LANGCODE : 'en';
        $this->calendar_lang_file  = 'lang/calendar-' . $lang . '.js';
        $this->calendar_lib_path   = 'modules/xooslacore/thirdparty/calendar/';
        $this->calendar_theme_file = 'calendar-blue.css';
        $this->calendar_theme_url  = 'modules/xooslacore/thirdparty/calendar/css/';
    }
