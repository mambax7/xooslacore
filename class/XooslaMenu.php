...
class XooslaMenu
{
    ...
    public function render($tpl)
    {
        ...
        if (file_exists($file = $GLOBALS['xoops']->path('/modules/' . $GLOBALS['xoopsModule']->getVar('dirname') . '/language/' . $GLOBALS['xoopsConfig']['language'] . '/help/' . $this->menu_helpfile . '.tpl'))) {
