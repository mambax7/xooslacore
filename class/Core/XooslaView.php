...
class XooslaView
{
    ...
    {
        \XoopsModules\Xooslacore\Core\XooslaLoad::getInclude('class.template');
    ...
    {
        $pageNav = new Xooslacore\XooslaPageNav();
    ...
    {
        $mHandler = Core\XooslaLoad::getClass('Menu', $this->formName);
        $mHandler->loadMenu();
    ...
    {
        if ($this->toolbar) {
            $xooslaToolbar =  new Xooslacore\XooslaToolbar();
