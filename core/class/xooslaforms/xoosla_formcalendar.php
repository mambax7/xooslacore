 ...
 * @version : $Id: formcalendar.php 0000 25/03/2009 11:21:03:000 Catzwolf $
 */
...
class XooslaFormCalendar extends XoopsFormElement {
     ...
     */
    function XooslaFormCalendar( $caption, $name, $initial_value = 0, $calendar_options = array(), $calendar_field_attributes = array() ) {
        $stripped = false;
        ...
        $lang = file_exists( XOOPS_ROOT_PATH . 'modules/xooslacore/class/calendar/lang/calendar-' . _LANGCODE . '.js' ) ? _LANGCODE : 'en';
        $this->calendar_lang_file = 'lang/calendar-' . $lang . '.js';
        $this->calendar_lib_path = 'modules/xooslacore/class/calendar/';
        $this->calendar_theme_file = 'calendar-blue.css';
        $this->calendar_theme_url = 'modules/xooslacore/class/calendar/css/';
    }
